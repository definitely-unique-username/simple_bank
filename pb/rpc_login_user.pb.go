...
type LoginUserResponse struct {
	state                 protoimpl.MessageState `protogen:"open.v1"`
	SessioId              string                 `protobuf:"bytes,1,opt,name=sessio_id,json=sessioId,proto3" json:"sessio_id,omitempty"`
...
func (x *LoginUserResponse) GetSessioId() string {
	if x != nil {
		return x.SessioId
	}
	return ""
...
const file_rpc_login_user_proto_rawDesc = "" +
	...
	"\x11LoginUserResponse\x12\x1b\n" +
	"\tsessio_id\x18\x01 \x01(\tR\bsessioId\x12!\n" +
	...
	"\x04user\x18\x06 \x01(\v2\b.pb.UserR\x04userB6Z4github.com/definitely-unique-username/simple_bank/pbb\x06proto3"
